...
extern coap_resource_t res_actuator;
 ...
 //struct etimer timer_irrigation;
 //struct etimer timer_leds;



bool buttonLeftClicked = false;//To manual activation irrigation
...
{
	PROCESS_BEGIN();
  //PROCESS_PAUSE(); perché c'era questo????
